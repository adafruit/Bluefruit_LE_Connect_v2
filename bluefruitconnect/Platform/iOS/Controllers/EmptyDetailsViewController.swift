...
class EmptyDetailsViewController: ModuleViewController {
  ...
  override func viewWillAppear(_ animated: Bool) {
    ...
    setConnecting(isConnecting: isConnnecting)
    }
    ...
    func setConnecting(isConnecting : Bool) {
        ...
        emptyLabel?.text = localizationManager.localizedString(key: isConnecting ? "peripheraldetails_connecting" : "peripheraldetails_select")
    }
